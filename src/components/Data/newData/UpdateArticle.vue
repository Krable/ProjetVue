  ...
  methods: {
    checkForm: function(e) {
      if (this.titre && this.contenu) {
        let apiUrl = "http://127.0.0.1:5000/editArticle"; //"https://deploiementheroku.herokuapp.com/login";
        ...
        Axios.post(apiUrl, data, {
          ...
          .catch(error => {
            console.log(error);
            this.errors.push(
              "Vous devez vous connecter pour mettre à jour un article"
            );
          });
